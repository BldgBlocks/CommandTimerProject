...
public static class ThicknessTransitionHelper {

    public static ThicknessTransition CreateAnimation(int milliseconds = 300, Easing? easing = default) {
        var builder = new ThicknessTransition() {
    ...
    public static ThicknessTransition WithProperty(this ThicknessTransition transition, StyledProperty<Thickness> viewControlProperty) {
        transition.Property = viewControlProperty;
        return transition;
    }

    public static ThicknessTransition WithTime(this ThicknessTransition transition, int milliseconds) {
        transition.Duration = new TimeSpan(0, 0, 0, 0, milliseconds);
        return transition;
    }

    public static ThicknessTransition WithEasing(this ThicknessTransition transition, Easing easing) {
    ...
    public static ThicknessTransition WithBind(this ThicknessTransition transition, Control control, string nameOfDataContextProperty, out BindingExpressionBase token) {
    ...
    /// </summary>
    public static void Remove(this ThicknessTransition transition, Control control) {
        if (control.DataContext is null) {
            throw new ArgumentNullException("The provided control does not have a DataContext set.");
        }
    ...
    /// </summary>
    public static void Unbind(this ThicknessTransition transition, BindingExpressionBase token) {
