    ...
    private record Windows_Simple {
        public IEnumerable<CommandTimerViewModel> Timers => [
            new() {
                ...
                ColorBarColor = ColorUtilities.ParseHexToColor("#cc79a7"),
                Command = "shutdown /s /t 3",
            },
            new() {
                Name = "Show all open ports",
                Description = "Show detailed network information",
                ColorBarColor = ColorUtilities.ParseHexToColor("#009e73"),
                Command = "netstat -an",
                IsShowTerminal = true,
            },
            new() {
            ...
            new() {
                ...
                ColorBarColor = ColorUtilities.ParseHexToColor("#0072b2"),
            ...
            new() {
                ...
                ColorBarColor = ColorUtilities.ParseHexToColor("#f0e442"),
    ...
    private record Linux_Simple {
        public IEnumerable<CommandTimerViewModel> Timers => [
            ...
            new() {
                ...
                ColorBarColor = ColorUtilities.ParseHexToColor("#d55e00"),
