...
public partial class SecondsFlyout : UserControl {

    private NumericUpDownBinding? binding;
    public NumericUpDown NumericUpDownControl;

    public SecondsFlyout() {
        InitializeComponent();
        NumericUpDownControl = FlyoutSecondsNumeric;
    }
    ...
    public NumericUpDownBinding Bind(FlyoutBase flyout, Button button) {
        ...
        binding = new NumericUpDownBinding(flyout, button, FlyoutSecondsNumeric);
        binding.Connect();
